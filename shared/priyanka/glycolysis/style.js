vizmap = [
   ...
   {selector: 'node[type="reaction"]', css: {
      "shape": "roundrectangle",
      "background-color":"mapData(flux, 0, 1, white, red)",
      "width":  "60px",
      "height": "60px"
       }},
   ...
   {selector: 'node[type="gene"][expression >=0]', css: {
      "background-color": "mapData(expression, 0, 20, white, red)"
       }},
   ...
   {selector: 'edge[edgeType="produces"][flux < 0]', css: {
      ...
      "curve-style":"bezier",
      "line-color": "mapData(flux, -0.3, 0, green, #EDEDED)",
      "width":      "mapData(flux, -0.3, 0, 10, 1)"
      }},
   ...
   {selector: 'edge[edgeType="produces"][flux >= 0]', css: {
      ...
      "curve-style":"bezier",
      "line-color": "mapData(flux, 0, 1, #EDEDED, red)",
      "width":      "mapData(flux, 0, 1, 1, 10)"
      }},
